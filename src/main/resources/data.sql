...
VALUES (UNHEX(REPLACE('019195e0-6999-199b-a747-0a02b343a12e', '-', '')), '【익산칼럼】 삶이 예술이 되는 공간 유휴공간 문화재생',
        ...
        'http://iksannews.com/data/newsThumb/1582278601ADD_thumb180.jpg', NOW(), NOW()) ON DUPLICATE KEY
UPDATE subtitle =
VALUES (subtitle), url =
VALUES (url), thumbnail_url =
VALUES (thumbnail_url), updated_at = NOW();
...
VALUES (UNHEX(REPLACE('019195e0-6f43-2132-8f38-369124d3c589', '-', '')), '노원구, 학교 유휴 시설을 문화예술 공간으로 단장',
        ...
        'https://img.hani.co.kr/imgdb/resize/2019/0726/156403294913_20190726.JPG', NOW(), NOW()) ON DUPLICATE KEY
UPDATE subtitle =
VALUES (subtitle), url =
VALUES (url), thumbnail_url =
VALUES (thumbnail_url), updated_at = NOW();